package africa.soimpaf.api_v1.config;

import africa.soimpaf.api_v1.enums.UserRole;
import africa.soimpaf.api_v1.models.Role;
import  africa.soimpaf.api_v1.config.jwt.JwtAuthenticationEntryPoint;
import  africa.soimpaf.api_v1.config.jwt.JwtRequestFilter;
import  africa.soimpaf.api_v1.config.jwt.JwtUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private void createDefaultRole() {
        try {
                ...
                roleRepository.save(Role.roleBuyer());
                roleRepository.save(Role.roleFamer());
